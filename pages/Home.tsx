...
// import { PRODUCTS } from '../constants'; // Replaced by dynamic data
...
export const Home: React.FC<HomeProps> = ({ onProductClick }) => {
            ...
            try {
                ...
                if (data) {
                    const mapped: Product[] = data.map((p: any) => {
                        ...
                        // Sort variants logicaly same as in Selector if needed, or rely on Selector
                        ...
                        return {
                            ...
                            // sizes array for fallback if needed, but variants is primary now
    ...
    return (
        <div className="min-h-screen bg-gray-100 pb-20">
            ...
            {/* Categories / Quick Links - FILTERED */}
            <div className="bg-white py-6 px-4 mb-4 shadow-sm overflow-x-auto">
                <div className="flex gap-6 min-w-max md:justify-center">
                    {[
                        ...
                        // onClick={() => handleCategoryClick(cat.label)} // No more unavailable handling needed
                        >
            ...
            {/* Main Feed (Infinite Scroll Style) */}
